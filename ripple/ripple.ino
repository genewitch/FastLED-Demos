...
uint8_t max_bright = 6;                                     // Overall brightness definition. It can be changed on the fly.
...
void setup() {
  ...
  LEDS.addLeds<LED_TYPE, LED_DT, COLOR_ORDER>(leds, NUM_LEDS).setCorrection(ClearBlueSky);        // Use this for WS2812B
